...
export default class Scene1 extends Phaser.Scene {
    ...
    preload() {
        //teste
        this.load.image('tile_teste', './assets/mapas/mapa_teste5/[Base]BaseChip_pipo-export.png');
        this.load.tilemapTiledJSON('map_teste', './assets/mapas/mapa_teste5/teste5.json');
    ...
    criarMapa() {
        ...
        this.tilesetTeste = this.map.addTilesetImage('[Base]BaseChip_pipo-export', 'tile_teste');
        this.teste = this.map.createLayer('teste5', this.tilesetTeste, 0, 0);
